...
class ImageResizedModelFile(ImageField.attr_class):
    ...
    def save(self, name, content, save=True):
        ...
        super(ImageResizedModelFile, self).save(name, new_content, save)
...
class ImageResizedModel(ImageField):

    attr_class = ImageResizedModelFile
    ...
    def __init__(self, verbose_name=None, name=None, **kwargs):
        ...
        for argname in depricated:
            if argname in kwargs:
                sys.stderr.write('Error: Keyword argument %s is deprecated for ImageResizedModel, see README https://github.com/un1t/django-resized\n' % argname)
                del kwargs[argname]
        ...
        super(ImageResizedModel, self).__init__(verbose_name, name, **kwargs)
